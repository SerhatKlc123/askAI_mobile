                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: TextField(
                            ...
                            style: monserratMedium.copyWith(fontSize: 16.sp),
                            ...
                            decoration: InputDecoration(
                              ...
                              suffixIcon: GestureDetector(
                                  onTap: () {
                                    if (_textController.text.isNotEmpty && !_chat.chatLoad.value) {
                                      if (_chat.chatID.isEmpty) {
                                        ...
                                        _chat
                                            .createWebChat(_textController.text)
                                            .then(
                                                (value) => _chat.setChatLoad());
                                  ...
                                  child: Icon(Icons.send_outlined,
                                      color: Colors.grey.shade400, size: 30.r)),
                            )),
                      ),
                    ],
                  ),
